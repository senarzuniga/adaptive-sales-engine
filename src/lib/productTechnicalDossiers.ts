...
const DOSSIERS: Record<string, ProductTechnicalDossier> = {
  ...
  'ingetrans smart': dossier(
    'ING-P01S',
    'Rail-less, battery-powered INGETRANS: the same automatic reel delivery and return without embedded rails, conductor line or fixed feed, on INGECART IGC-DW drive wheels with laser navigation and full-machine CE marking by INGECART.',
    ['Brownfield corrugators where rail civil works are not feasible', 'Plants with buried services or rented buildings', 'Layouts expected to change or add roll stands', 'Sites needing per-transfer traceability without freezing the layout'],
    [
      { parameter: 'Drive wheel', value: 'IGC-DW100 only (10,000 kg per wheel, 5,000 W traction, 3,000 W steering, 0.43 m/s); 48 V DC; IP65; CANopen CiA 301/402. IGC-DW20 is not offered for reel duty.', status: 'verified' },
      { parameter: 'Reference reel-carrier configuration', value: '4 x IGC-DW100 plus supports, total mass up to 40,000 kg; about 8,000 kg for dual reels plus tare', status: 'pre-engineering' },
      { parameter: 'Travel speed', value: '0.43 m/s (26 m/min) versus 80 m/min rail INGETRANS; 0.30 m/s approach and manual; 30 m mission about 154 s', status: 'verified' },
      { parameter: 'Positioning', value: '+/-20 mm by laser navigation, +/-5 mm at station by local reference', status: 'verified' },
      { parameter: 'Energy', value: '48 V 200 Ah LiFePO4, 7.68 kWh usable, 7.3 h at 30 cycles/h, 3.3 h recharge, about 1.3 kWh per operating hour', status: 'verified' },
      { parameter: 'Safety', value: 'Scanners, four-side E-stop, bumper and safely limited speed at PL d Cat. 3; holding brake and transfer interlock PL c; EN ISO 3691-4', status: 'verified' },
      { parameter: 'Removed infrastructure', value: 'More than 60 m of embedded rails, Vahle conductor line and fixed feed; rail installation service block not required', status: 'verified' },
      { parameter: 'Programme', value: '18-20 weeks from order to CE handover; 2-5 days on-site installation without zone shutdown', status: 'verified' },
      { parameter: 'Smart carrier cost and price', value: 'Product cost breakdown pending; Paige offer at same EXW as rail INGETRANS', status: 'pending' },
    ],
    ['Mission time P50/P95 and request-to-delivery', 'Starvation minutes per 1,000 hours', 'Battery state of charge, cycles and energy per mission', 'Station positioning error and localization quality', 'Protective-field intrusions and safety events', 'Wheel motor current, following error and tread wear index', 'Availability, MTBF and MTTR'],
    ['Avoided rail civil works, conductor line and zone shutdown (32,000-62,000 EUR indicative for a 26 m route, scaling with corridor length)', 'Avoided lost production during installation', 'Recovered corrugator output as in rail INGETRANS', 'Realizable forklift labor', 'Charging station, Wi-Fi reinforcement, battery replacement year 7-10 and about 1.3 kWh per hour as new costs'],
    ['Peak speed is about 32% of rail INGETRANS; dual-reel trips required for far roll stands; rail keeps the advantage above about 20-25 single-reel missions per hour on a 60 m corridor', 'Floor must be sound industrial concrete with local deviation below about 5 mm over 2 m and joints below 20 mm', 'Battery autonomy for the reel profile with four IGC-DW100 wheels to be calculated in the application study', 'Cost breakdown for the Smart carrier not yet available'],
    ['Stopping distances measured with the customer reel at FAT and SAT', 'Station positioning within 5 mm over 100 consecutive missions', 'Opportunity-charging cycle never stops with a reel on board', 'Safety function validation per EN ISO 13849-2', 'Digital-twin capacity confirmation on approved layout'],
    ['INGETRANS_smart_technical data.html (P0001_2026 Rev. 1, 2026-09-14)', 'ingetrans_smart_technical_baseline_R2_2026-09-14.json', 'INGETRANS_SMART_PRODUCT_REPORT_IGC-DW_R2_2026-09-14.html'],
  ),
