...
const DOSSIERS: Record<string, ProductTechnicalDossier> = {
  ...
  'ingetrans smart': dossier(
    ...
    [
      { parameter: 'Drive wheel family', value: 'IGC-DW20 (2,000 kg per wheel, 1,570 W, 0.90 m/s) and IGC-DW100 (10,000 kg per wheel, 5,000 W, 0.43 m/s); 48 V DC; IP65; CANopen CiA 301/402', status: 'verified' },
      { parameter: 'Reference reel-carrier configuration', value: '4 x IGC-DW20 plus castors up to 6,000 kg total mass; 4 x IGC-DW100 up to 40,000 kg', status: 'pre-engineering' },
      { parameter: 'Travel speed', value: '0.90 m/s (54 m/min) with DW20 versus 80 m/min rail INGETRANS; 0.30 m/s approach and manual', status: 'verified' },
    ...
    ['Peak speed is about 68% of rail INGETRANS; rail keeps the advantage above about 60 sustained transfers per hour', 'Floor must be sound industrial concrete with local deviation below about 5 mm over 2 m and joints below 20 mm', 'Reel-carrier wheel configuration and mass distribution still to be fixed by the reel matrix', 'Cost breakdown for the Smart carrier not yet available'],
